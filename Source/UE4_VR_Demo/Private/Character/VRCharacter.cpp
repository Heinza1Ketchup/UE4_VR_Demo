...
void AVRCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("InteractLeft", IE_Released, this, &AVRCharacter::InteractLeftRelease);
	PlayerInputComponent->BindAction("InteractRight", IE_Released, this, &AVRCharacter::InteractRightRelease);
...
//
void AVRCharacter::OnHealthChanged(USHealthComponent* OwningHealthComp, float Health, float HealthDelta, const class UDamageType* DamageType, class AController* InstigatedBy, AActor* DamageCauser)
{
